...
// Version History
// 1-6 Tests for SV06, 7 SV06+, 8 PID settings for SV06+, 9 Versioning, 10 Homing current, 11 Diff filesize
...
#define KS_MOTOR_XY_HOLD_MULTIPLIER     1
#define KS_MOTOR_XY_RUN_CURRENT         650
#define KS_MOTOR_XY_HOME_CURRENT        270     // when home == run; home will be set to always use run current
